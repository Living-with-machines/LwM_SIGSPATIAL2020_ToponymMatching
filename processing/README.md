...
* `gazetteers`: code to obtain or generate gazetteers that will be used to generate toponym matching dataset and to evaluate candidate ranking. Run them in the following order:
  1. [`generate_wikigazetteers.ipynb`](https://github.com/Living-with-machines/LwM_SIGSPATIAL2020_ToponymMatching/blob/tm_experiments/processing/gazetteers/generate_wikigazetteers.ipynb)
  2. [`prepare_gazetteers.ipynb`](https://github.com/Living-with-machines/LwM_SIGSPATIAL2020_ToponymMatching/blob/tm_experiments/processing/gazetteers/prepare_gazetteers.ipynb)
* `toponym_matching_datasets`: code and [instructions](https://github.com/Living-with-machines/LwM_SIGSPATIAL2020_ToponymMatching/blob/tm_experiments/processing/toponym_matching_datasets/README.md) to create and process the datasets used for evaluation of toponym matching (`WG:en`, `WG:es`, `WG:el`, `OCR dataset`, and `santos`).
